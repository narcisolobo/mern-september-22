/* 
  Given an id, an object that has keys with corresponding updated
  values, and an array of objects, find the object by "id" key that
  matches the given id value and then update that object's keys with
  the provided new values.
